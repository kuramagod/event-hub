...
- 🗂️ Карточка мероприятия содержит: название, адрес, дату и время, изображение по ссылке, цену (или отметку **«Бесплатно»**, если цена не указана) и подробное описание
...
│   ├── static/
│   │   ├── css/
│   │   │   └── style.css          # Стили (Tailwind + кастомные правила)
│   │   ├── images/                # Ассеты, иконки
│   │   └── js/
│   │       ├── add_event.js       # Логика формы создания мероприятия
│   │       ├── app.js             # Общие скрипты (навбар, интерактив)
...
- [ ] Уведомления на email о новых мероприятиях по подписке
- [ ] REST API — задел под мобильный клиент
