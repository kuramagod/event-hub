...
### Админка
- 🛡️ В проект подключён **Flask-Admin** для управления данными через веб-интерфейс
- 👑 Доступ к панели администратора ограничен только для пользователей с ролью `1`
- 📊 В админке доступны управление пользователями, ролями, категориями, городами, мероприятиями и избранным
